<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="ICTProject.usersignup" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">                      
                        <div class="form-group"><p>
                           <asp:Button class="btn btn-primary btn-success w-100 btn-lg" ID="Button1" runat="server" Text="Sign Up" OnClick="Button1_Click" />                      
                        </p></div>          
                     </div>
                  </div>
               </div>
